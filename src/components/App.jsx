...
function App() {
    ...
    const [isFullSizeImagePopupOpen, setIsFullSizeImagePopupOpen] = useState(false)
    ...
    const handleCardClick = (card) => {
        ...
        setIsFullSizeImagePopupOpen(true)
    }
    ...
    const closeAllPopups = () => {
        ...
        setIsFullSizeImagePopupOpen(false);
        setSelectedCard({})
    ...
    return (
        <>
            ...
            <ImagePopup
                card={selectedCard}
                onClose={closeAllPopups}
                isOpen={isFullSizeImagePopupOpen}
                name={'image'}/>
        </>
    );
}
